...
const HISOPDInfectiousLink = ({isActive}) => {
    const { pending, pendingForRelease } = useOPDInfectiousQueue();
    return (
      <>
              ...
              />
              <MenuLink
                  to="/opd-infectious-queue"
                  active={isActive("/opd-infectious-queue")}
...
export default HISOPDInfectiousLink